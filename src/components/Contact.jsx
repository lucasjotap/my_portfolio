  ...
  return (
    <section id="contact" className="py-24 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        >
          <h2 className="text-5xl md:text-6xl font-extrabold text-black dark:text-black">
            Get In Touch
          </h2>

          <div className="w-32 h-3 bg-black dark:bg-black mx-auto my-6"></div>

          <p className="text-black dark:text-black text-lg font-semibold">
            I'm always open to new projects or opportunities.
          </p>
        </motion.div>
