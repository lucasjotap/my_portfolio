    ...
    <section id="contact" className="py-20 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="w-24 h-1 bg-gradient-to-r from-purple-400 to-pink-400 mx-auto rounded mb-6"></div>
        ...
        >
          {contactMethods.map((method, index) => (
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
            >
              <div className="flex justify-center mb-4 text-purple-400 group-hover:text-purple-300 transition-colors">
                {method.icon}
              </div>
              <h3 className="text-xl font-bold mb-2 text-gradient">{method.name}</h3>
